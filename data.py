...
class VQA(data.Dataset):
    ...
    def __init__(self, questions_path, answers_path, image_features_path, answerable_only=False, dummy_answers=False):
        ...
        self.questions_type = list(prepare_questions_type(answers_json)) 
    ...
    def _load_image(self, image_id):
        ...
        boxes[0] = boxes[0] / widths
        boxes[2] = boxes[2] / widths
        boxes[1] = boxes[1] / heights
        boxes[3] = boxes[3] / heights
    ...
    def __getitem__(self, item):
        ...
        q_type = self.questions_type[item]
        ...
        return v, q, a, b, q_type, item, q_length
...
def prepare_questions_type(answers_json):
    """ Get 65 Question Type for further analysis """
    type_que = [a['question_type'] for a in answers_json['annotations']]
    type_ind = [question_type_dict[tp] for tp in type_que]
    return type_ind
